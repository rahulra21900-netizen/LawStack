  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20 text-center relative z-10">
      ...
      <p className="text-sm text-slate-400 max-w-xl mx-auto leading-relaxed mb-8">
        This is a placeholder page representing the upcoming Features catalog. LawStack V2 will support document management, intelligent billing, case tracking, and AI integration.
      </p>
      <Link
        href="/"
